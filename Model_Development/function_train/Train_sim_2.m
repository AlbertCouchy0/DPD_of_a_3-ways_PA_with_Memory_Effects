function model=Train_sim_2(M,input,output,vec,regularizationCoeff)
%% 预处理
% dim = length(input);
dim = 4000;
div = 2100;
...
% 配置训练选项
net.trainFcn = 'trainbr';       % 使用Levenberg-Marquardt算法
net.trainParam.epochs = 4000;   % 最大迭代次数
net.trainParam.max_fail = 20;    % 验证失败次数（类似ValidationPatience）
